...
public class AppProperties {
    ...
    public static class KeycloakProperties {
        ...
        private List<String> clientRoleClients;
        private PresentationDefinitionProperties presentationDefinition = new PresentationDefinitionProperties();

        @Getter
        @Setter
        public static class PresentationDefinitionProperties {
            private boolean enabled = false;
            private String clientId;
